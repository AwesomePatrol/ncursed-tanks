...
OBJS_server := server.o common.o server_game.o server_abilities.o server_data.o server_net.o dyn_arr.o server_updates_queue.o config.o debug.o map.o shot.
